...
?>
    <div id="msp-header">
        ...
        <?php if( isset( $_GET['action'] ) && 'edit' == $_GET['action'] ) { ?>
            <a class="upgrade-pro" href="https://avt.li/mslpan" title="<?php _e( "Upgrade to PRO version to unlock more features. Click to see the list of features." ); ?>" target="_blank"><?php _e( "Upgrade to PRO Version", 'master-slider' ); ?></a>
      <?php } ?>
    </div>
