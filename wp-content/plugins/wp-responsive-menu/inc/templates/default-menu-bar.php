...
<div id="wprmenu_bar" class="wprmenu_bar <?php echo esc_html( $slide_type . ' '. $position ); ?>">
  <div class="wrappper-btn">
    <a href="tel:<?php echo trim(get_option('phone')) ?>"><img class="img-fluid phone-iocn" src="<?php echo get_template_directory_uri() ?>/img/icons/phone.png" alt="phone"></a>
